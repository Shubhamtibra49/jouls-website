    ...
    <div class="footer-container">
      ...
      <div class="column contactus">
        ...
        <ul class="contact-info text-left ">
            <a href="tel:+916377650430"  target = "_blank" rel="noreferrer" style={{color:"#118615"}}><li style={{textAlign:'center'}}>+91 6377 650 430</li></a>
            <a href={'mailto:${amangoyal6377@gmail.com}'}  target = "_blank" rel="noreferrer" style={{color:"#118615"}} ><li  style={{textAlign:'center'}}>amangoyal6377@gmail.com</li></a>
      ...
      <div class="column asdf">
        <div class="app-download">
          <div class="row">
            <div class="app-icon">
              <a href="https://play.google.com/store/apps/details?id=com.Jouls"target = "_blank" rel="noreferrer" ><img src={img2}alt="Available on App Store"/></a>
            </div>
